    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  key={index}
                  className={`border border-gray-300 py-2 px-4 bg-gray-50 cursor-pointer ${
                    size === item ? 'border-2 border-orange-500' : ''
                  }`}>
                  {item}
                </button>
              ))}
          ...
          <button onClick={() => addToCart(productData._id, size)} className="bg-black text-white py-3 px-8 text-sm active:bg-gray-700 cursor-pointer">
            ADD TO CART
          </button>
      ...
      <div className="mt-20">
        <div className="flex">
          ...
          <p className="border border-l-0 text-sm py-3 px-5">Reviews (122)</p>
        </div>
        <div className="flex flex-col border py-6 px-6 text-sm text-gray-400 gap-4">
          <p>
