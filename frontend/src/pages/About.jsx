...
const About = () => {
  return (
    ...
    <hr />
	  <div className="text-xl sm:text-2xl text-center mt-8">
      <Title text1={'ABOUT'} text2={'US'}/>
    </div>

    <div className='flex flex-col md:flex-row items-center my-10 gap-16'>
    ...
    <div className='flex flex-col lg:flex-row text-sm mb-20'>
      <div className='border border-gray-300 px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
        ...
        <p>We take pride in sourcing only the highest quality products, ensuring that each item meets our rigorous standards of excellence.</p>
      </div>
      <div className='border border-gray-300 px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
        <b>Convenience: </b>
